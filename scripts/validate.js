...
const requiredPlatforms = ["GCP","Snowflake"];
const requiredSignals = ["egress cost","warehouse burn","BigQuery slot pressure"];
...
console.log('gcp-snowflake-data-egress-cost-guardrail: validation passed');
